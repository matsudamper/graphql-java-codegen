#!/bin/bash
#
# Updates the version referenced in all README files.
# Usage: scripts/update-release-version-in-readme.sh <version>
#
set -euo pipefail
...
set_version_in_file "plugins/gradle/README.md" "classpath \"io.github.kobylynskyi:graphql-java-codegen-gradle-plugin:"
