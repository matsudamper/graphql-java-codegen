package net.matsudamper.graphql.codegen.gradle;

import net.matsudamper.graphql.codegen.GraphQLCodegen;
import net.matsudamper.graphql.codegen.java.JavaGraphQLCodegen;
import net.matsudamper.graphql.codegen.kotlin.KotlinGraphQLCodegen;
import net.matsudamper.graphql.codegen.model.ApiInterfaceStrategy;
...
import net.matsudamper.graphql.codegen.model.GraphQLCodegenConfiguration;
import net.matsudamper.graphql.codegen.model.MappingConfig;
import net.matsudamper.graphql.codegen.model.MappingConfigConstants;
import net.matsudamper.graphql.codegen.model.exception.LanguageNotSupportedException;
import net.matsudamper.graphql.codegen.supplier.SchemaFinder;
